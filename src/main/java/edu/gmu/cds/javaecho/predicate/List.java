...
package edu.gmu.cds.javaecho.predicate;
...
public class List {
  ...
  private ArrayList list_ = new ArrayList();  // list_ is a ArrayList of list_
...
*/
  public List(String s) throws IOException
  {
    ...
    //StreamTokenizer st = makeTokenizer(new ByteArrayInputStream(s.getBytes("UTF-8"));
...
*/
				...
				char right) throws IOException
  {
	...
	result.add(in.sval);   // add the argument
      } else if (in.ttype == '\"') {
	result.add("\""+in.sval+"\"");
      } else
...
/**
  ...
  Parses a list stored as a String, and returns the result as a ArrayList.
  Default delimeters are used.
  
   @param list the input String to parse
   @return a ArrayList representation of the items in list: sublists are stored
         as lists, while strings delimited by " are stored as Strings 
         delimited by ", and everything else is a String
   @exception IOException if is cannot be parsed, an exception
             is thrown indicating the particular problem
*/
  public final ArrayList readList(String list) throws IOException
  {
...
/**
  ...
  Supplied delimeters are used.
   ...
   @exception IOException if is cannot be parsed, an exception
             is thrown indicating the particular problem
*/
  public static ArrayList readList(String list, char left, char sep, char right)
    throws IOException
  {
...
/**
  ...
  Supplied delimeters are used.
   ...
   @return a ArrayList representation of the items in is: sublists are stored
         as lists, while strings delimited by " are stored as Strings 
         delimited by ", and everything else is a String
   @exception IOException if is cannot be parsed, an exception
             is thrown indicating the particular problem
*/
  public final ArrayList readList(InputStream is) throws IOException
  {
...
/**
  ...
  Supplied delimeters are used.
   ...
   @exception IOException if is cannot be parsed, an exception
             is thrown indicating the particular problem
*/
  public static ArrayList readList(InputStream is, char left, char sep, 
...
/**
  ...
  Supplied delimeters are used.
   ...
   @exception IOException if is cannot be parsed, an exception
             is thrown indicating the particular problem
*/
  public ArrayList readList(StreamTokenizer in) throws IOException
  {
...
*/
  public static StreamTokenizer makeTokenizer(String s)
  {
    ...
    try {
        t = makeTokenizer(new ByteArrayInputStream(s.getBytes("UTF-8")));
    } catch (Exception e){
...
/**
  @return returns a ArrayList holding the references to each of the top-level
    items in this List
*/
  public ArrayList topLevelElements()
  {
    return list_;
  }
